...
;(function () {
    ...
    window.TransformClick = function(clickX, clickY){
        var point = new Matrix3D().set(clickX, clickY, 0, 1);
        console.log("point:  ",point)
        var transformation = new Matrix3D();
        console.log("transformation:  ",transformation)

        // Set the transformation matrix
        var transformedPoint = new Matrix3D().multiplyMatrices(transformation, point);

        var w = transformedPoint.elements[3];
        var transformedX = transformedPoint.elements[0] / w;
        var transformedY = transformedPoint.elements[1] / w;
        console.log("TransformClick",{ x: transformedX, y: transformedY })
